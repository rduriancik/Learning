package chapterApps.genericMatrix;
...
public abstract class GenericMatrix<E extends Number> {
     ...
     * Add two matrices
     */
    protected E[][] addMatrices(E[][] matrix1, E[][] matrix2) {
        if ((matrix1.length != matrix2.length) ||
                (matrix1[0].length != matrix2[0].length)) {
            throw new RuntimeException("The matricesdo not have the same size");
        }
     ...
     */
    protected E[][] multiplyMatrices(E[][] matrix1, E[][] matrix2) {
