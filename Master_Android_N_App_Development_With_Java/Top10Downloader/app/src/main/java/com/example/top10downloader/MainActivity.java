...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String STATE_URL = "feed_url";
    private static final String STATE_LIMIT = "feed_limit";
...
//            listApps.setAdapter(arrayAdapter);
            ...
            tvTitle.setText(parseApplications.getTitle());
        }
...
//                BufferedReader reader = new BufferedReader(inputStreamReader);
                ...
                Log.e(TAG, "downloadXML: Security Exception. Needs permission? " + ex.getMessage());
            }
